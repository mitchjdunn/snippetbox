...
// method and UIR as attributes), the nsends a generic 500 server error
...
// to hte user. We'll use this later in the book to send responses like 400 "Bad
// Request" when theres a problem with the request that the user sent
...
// Returns true if user is authenticated, returns false otherwise
